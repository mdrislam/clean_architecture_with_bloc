...
// in tikweb_task/test/features/repo_exploler/domain/usecases/fetch_repo_repository_usecase_test.dart.
...
class MockRepoRepository extends _i1.Mock implements _i2.RepoRepository {
  ...
  @override
  _i3.Future<List<_i4.RepoEntity>> getRepositories({
    ...
    int? perPage,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i3.Future<List<_i4.RepoEntity>>.value(<_i4.RepoEntity>[]),
      ) as _i3.Future<List<_i4.RepoEntity>>);
}
